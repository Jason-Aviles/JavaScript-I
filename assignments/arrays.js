...
let oldCars = [];
 let newCars =carYears.sort();

 oldCars =  newCars.filter(n => n>1000 && n<1999);
console.log(oldCars); 
...
let  BMW =  BMWAndAudi.filter(n =>  n === 'BMW' )
let  Audi =  BMWAndAudi.filter(n => n === 'Audi' )

let AudiAndBMW =BMW +','+ Audi
let newBMWAndAudi =JSON.stringify(AudiAndBMW)
